...
package com.eroh.mit.insafety.detection.utils.tracking;
...
public class MultiBoxTracker {
  ...
  public synchronized void draw(final Canvas canvas) {
    ...
    for (final TrackedRecognition recognition : trackedObjects) {
      ...
      float cornerSize = Math.min(trackedPos.width(), trackedPos.height()) / 16.0f;
      ...
      borderedText.drawText(
          canvas, trackedPos.centerX(), trackedPos.bottom + cornerSize, labelString + "%", boxPaint);
    }
  }
